...
const Home = ({ ...props }: SectionProps) => {
  return (
    <Section
      {...props}
      className="h-[90svh] md:h-screen flex-col bg-background md:bg-gradient-to-r sm:from-transparent sm:from-[62.5%] sm:to-site-secondary sm:to-[62.5%] mb-40 relative"
    >
